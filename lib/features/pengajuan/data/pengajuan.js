...
router.put('/api/pengajuan/:id', handleUpload, async (req, res) => {
    ...
    try {
        ...
        const shouldPreserveEmptyPenjamin = String(stsflag || '') === PENGAJUAN_STATUS.FPK_AO && hasOwnPayload(body, 'list_penjamin') && Array.isArray(list_penjamin) && list_penjamin.length === 0;
